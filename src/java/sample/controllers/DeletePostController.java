...
public class DeletePostController extends HttpServlet {
    ...
    private Logger logger = Logger.getLogger(DeletePostController.class.getName());
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            emotionDAO.deleteEmotion(articleID);
       
            ArticleDAO articleDAO = new ArticleDAO();
            articleDAO.deleteArticle(articleID);
            
            NotificationDAO notificationDAO = new NotificationDAO();
            notificationDAO.deleteNotification(articleID);
            
            url = SUCCESS + "?txtSearch=";       
        } catch (Exception e) {
            logger.error("Error in DeletePostController: " + e);
        }finally{
